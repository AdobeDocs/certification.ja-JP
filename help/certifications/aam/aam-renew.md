...
**セクション 6：プロファイルの結合、ID の同期、Audience Marketplace(14%)**
...
* 利用可能な言語：英語
* コスト：無料
* 試験 ID: AD5-E826 - Adobe Audience Manager Business Practior Expert Renewal Exam
...
* 利用可能な言語：英語
* コスト：無料
* 試験 ID: AD5-E825 - Adobe Audience Manager Architectマスター更新試験
