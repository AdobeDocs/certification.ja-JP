...
* 機能の特定 [!DNL Adobe Analytics] レポートスイートと変数の設定を参照してください。
...
* [[!DNL Adobe Analytics]：電子メールマーケティング (ESP) 統合のケーススタディ](https://adobeexchangeec.zendesk.com/hc/en-us/articles/360003848112-Adobe-Analytics-Email-Marketing-ESP-Integration-Case-Study){target="_blank"}
...
* [linkDownloadFileTypes](https://experienceleague.adobe.com/docs/analytics/implementation/vars/config-vars/linkdownloadfiletypes.html?lang=ja){target="_blank"}
