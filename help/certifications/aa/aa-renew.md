...
* 配信：オンデマンド
* 利用可能な言語：英語
* 前提条件：現在の（期限切れではない）Adobe Analytics Business Professional 認定
* 試験 ID: AD5-E832
...
上記の手順 1 に従い、に正常にログインしたことを確認します。 [Adobe資格管理システム](https://www.certmetrics.com/adobe){target="_blank"} 1 つ目は。 次に、証明書を更新するには、以下の「AD5-E832 Adobe Analytics Business Practior Professional Renewal Exam(AD5-E832)」リンクをクリックします。

* [AD5-E832 Adobe Analytics Business Practioner Professional Renewal Exam](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=AD5-E832){target="_blank"}
...
>[!NOTE]
>
>複数のAdobe Analyticsエキスパートおよびマスターの資格を持っている場合は、1 つの認定の更新要件を満たし、残りの認定は自動的に更新されます。
