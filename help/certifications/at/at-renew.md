---
title: 資格認定の更新
description: を更新する方法を学ぶ [!DNL Adobe Target] 有効期限が切れる前の資格認定。
solution: Target
product: Target
role: Developer
mini-toc-levels: 1
...
+++Adobe [!DNL Target] 業務担当者向け更新テスト

## 次のものが必要です **アクティブ** 更新の認定制度：
...
* 対象言語：英語
* 料金：無料
* 試験 ID: AD5-E838 -Adobe [!DNL Target] 業務従事者
...
* 適切な分析レポートソース（など）の説明 [!DNL Target] またはAdobe [!DNL Analytics]）
...
* の作成に適用されるワークフローの説明 [!DNL Target] アクティビティ
...
上記の手順 1 に従い、に正常にログインしていることを確認します。 [Adobe資格情報管理制度](https://www.certmetrics.com/adobe){target="_blank"} 1 番目。 次に、認証を更新するには、Adobeをクリックします [!DNL Target] 以下のビジネス実践者プロフェッショナル更新試験リンク。

[!BADGE Adobeを使用 [!DNL Target] 業務担当者向けプロフェッショナル再教育試験 AD5-E838]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=AD5-E838 newtab=true"}
...
>[!NOTE]
>
>複数のを保持する場合 [!DNL Adobe Target] エキスパート認定およびマスター認定は、1 つの認定の更新要件を満たし、残りは自動的に更新されます。
