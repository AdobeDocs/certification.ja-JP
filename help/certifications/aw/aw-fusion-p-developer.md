...
# 認定Adobe [!DNL Workfront Fusion] 開発者プロフェッショナル
...
* 指定された [!DNL Fusion] シナリオを選択し、適切な [!DNL Workfront] モジュールまたはアクション
* 指定された [!DNL Fusion] シナリオの場合、入力データを出力データに適切に変換するマッピングパネル式またはモジュールを選択します
* を正しく利用する方法を特定する [!DNL Fusion] 実行時のエラーのトラブルシューティングや、サードパーティシステムに対する呼び出しと応答の決定をおこなう開発ツール
...
* 指定された [!DNL Fusion] シナリオを作成して、設計を簡素化し、メンテナンスに最適化する機会を特定する
...
* バンドルインスペクターで見つかった情報の特定
* 60 日を超える期間、シナリオをアーカイブする必要があることを説明し、可能な唯一の方法（ブループリントの読み込み/書き出し）を選択します
* エラー 403 の例：許可されていません。エラーメッセージの起源を正しく選択し、原因を特定してください
...
* 429 を返すサードパーティ API が指定された場合：リクエストが多すぎる場合は、エラーを防いだり処理したりするためのソリューションを特定してください
...
* [Adobe [!DNL Workfront Fusion]](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FWorkfront_Fusion%2FOrganizations%2F_organizations.htm&amp;_LANG=enus){target="_blank"}
* [Adobe [!DNL Workfront Fusion]](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FWorkfront_Fusion%2FGet_Started%2F_Get_started.htm&amp;_LANG=en){target="_blank"}
...
* [Adobeのモジュール [!DNL Workfront Fusion]](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FWorkfront_Fusion%2FModules%2F_modules.htm&amp;_LANG=en){target="_blank"}
...
[!BADGE PSI]{type=Informative url="https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&amp;ec=AD0-E902 newtab=true"}[!BADGE 例]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E902 newtab=true"}
