...
* キャンペーンのニーズを考慮して、そのキャンペーンの戦略を決定します
* シナリオを指定した場合、新しいキャンペーンを作成します
* シナリオを指定した場合、パッケージを作成します
* ターゲティングを作成してプレースメントに適用するための手順の概念の適用
* プレースメントに広告を添付するための手順の概念の適用
* シナリオを指定した場合、キャンペーンの複製と編集
* キャンペーンのプライベートおよびオンデマンド在庫の設定に必要な手順概念の適用

**セクション 2：キャンペーンの実行と最適化（22%）**

* キャンペーンが正しく実行されていることを確認するために、手順の概念を適用します
* キャンペーンを最適化するための手順の概念の適用
...
* キャンペーンへの変更の実装
* シナリオを指定して、キャンペーンのパフォーマンスを評価します
* パフォーマンスをキャンペーンに関連付けるための手順概念の適用

**セクション 4：キャンペーンに対する推奨事項の提供（10%）**

* シナリオを指定した場合、キャンペーンに基づいてクライアントに更新を提供します
* シナリオを考えた場合、キャンペーンのパフォーマンスに基づいてキャンペーン戦略を調整します
