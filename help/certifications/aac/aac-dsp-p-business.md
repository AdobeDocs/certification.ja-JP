...
description: Adobe認定の取得方法を学ぶ [!DNL Advertising DSP] ビジネスプロフェッショナル。
solution: Advertising
product: Advertising Cloud
role: User
badge: label="試験 AD0-E502" type="positive"
mini-toc-levels: 1
...
# Adobeのための認定ジャーニー [!DNL Advertising DSP] ビジネスプロフェッショナル

認定を取得する方法を学ぶ [!DNL Adobe Advertising DSP] 実務者の専門家。
...
* キャンペーンのニーズを考慮し、そのキャンペーンの戦略を決定します
...
セクション 4：キャンペーンのレコメンデーションの提供 (10%)
