...
role: Developer
badge: label="試験 AD0-E124" type="positive"
mini-toc-levels: 1
...
AdobeManaged ServicesとAdobe Experience Manager as a Cloud Serviceでの作業に慣れ、Adobe Experience Manager環境とインフラストラクチャを設定できるようになります。
...
**セクション 1:Adobe Experience Managerの設定 (18%)**
...
* Dispatcher 設定を管理するための適切な方法を決定する
* シナリオについては、キャッシュの問題のトラブルシューティングを行います。
...
* インフラストラクチャを拡張する正しい方法を決定する

**第 6 節：Admin Consoleの運用 (8%)**
...
[オンライン準備に関するアンケートに従う](https://scorpion.caveon.com/launchpad/ad-q-e129-readiness-questionnaire-for-adobe-aem-assets-developer-professional-exam-copy-ejk3tx/ad-q-e124-readiness-questionnaire-for-adobe-aem-devops-engineer-expert-exam){target="_blank"}
...
* [厳しい 1 日：同じテストの複数のインスタンスの追加](https://experienceleague.adobe.com/docs/experience-manager-65/developing/testing/tough-day.html#adding-multiple-instances-of-the-same-test){target="_blank"}
