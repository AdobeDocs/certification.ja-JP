...
* LEO やタスクの依存関係を含むテクニカルロードマップを提供する機能
* プロジェクトの範囲とタイムラインに関する技術要件の情報を提供する機能
* ビジネス要件ワークショップの経験
* 業界をリードするソリューション設計ワークショップを実施
* 複数のソリューションアプローチを評価し、推奨事項を提供する機能
* 他のプラットフォームの既存のキャンペーンやプロセスを確認して、Adobe Campaign実装のニーズを判断する機能。
* 製品の特徴と機能を説明および実演する機能
* 製品機能を高いユースケースにマッピングする機能
* プリセールスチームをサポートした経験
* デスクサイドコーチングを提供する機能（製品ベストプラクティス、レポート指標など）
* デプロイメントモデルの違いを説明する経験
...
* 他の顧客ツールを使用した Campaign ソリューション用のデータモデルと統合マップの設計パラメーターの指定
* シナリオを考慮して、法令に準拠するために必要なソリューションデザインを決定します
* シナリオを考えた場合は、最適なテクニカルワークフロー設計を決定します
...
* シナリオを前提として、それぞれの環境に対するソリューションのプロモーションのための正しい方法を決定します

**セクション 4：プロジェクトのリーダー（10%）**

* お客様の要件を考慮して、必要な適切なアクティビティとリソースを決定します
...
* 追加のモジュールを使用して、ソリューションを設計するための正しい方法を決定する
