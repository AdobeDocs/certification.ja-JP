...
+++Adobe [!DNL Campaign Classic] 実務者の職務更新試験

## 次が必要です。 **アクティブ** 更新する証明書：

Adobe [!DNL Campaign Classic] ビジネスプロフェッショナル
...
* 配信：オンデマンド
* 利用可能な言語：英語
* 試験 ID: AD5-E841 -Adobe [!DNL Campaign Classic] ビジネスプロフェッショナル
...
セクション 2：ワークフロー管理とプラットフォーム機能 11.4%
...
* Adobe [!DNL Campaign Classic] 実務者エキスパート
...
* 配信：オンデマンド
* 利用可能な言語：英語
* 前提条件：現在の（期限切れでない）Adobe [!DNL Campaign Classic] エキスパート/マスター認定
* 試験 ID: AD5-E823
...
* [Adobeとの統合 [!DNL Campaign Classic]](https://experienceleague.adobe.com/docs/experience-manager-65/administering/integration/campaignonpremise.html?lang=ja){target="_blank"}
...
上記の手順 1 に従い、に正常にログインしたことを確認します。 [Adobe資格管理システム](https://www.certmetrics.com/adobe){target="_blank"} 1 つ目は。 その後、認定を更新するには、以下の「Campaign Classicの更新 — AD5-823」リンクをクリックしてください。
