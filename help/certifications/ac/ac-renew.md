---
title: 資格認定の更新
description: 期限切れの前にAdobe [!DNL Commerce]  認定制度を更新する方法を説明します。
solution: Commerce
product: Magento
...
+++Adobe[!DNL Commerce] 業務担当者

## この方法で更新するには、次の **アクティブ** 資格認定が必要です。

* 実務家 [!DNL Commerce]Adobe
...
* 対象言語：英語
* 料金：無料
* 試験 ID: AD5-E840Adobe[!DNL Commerce] 実務担当者向けプロフェッショナル再教育試験

**範囲と目的：**

セクション 1:Magento Open Sourceの主な機能（54%）

* Magento Open Sourceの特徴の特定
* 正しい範囲とそれぞれを使用するタイミングを区別する
* カタログ管理に関する知識を示す
* Magento Open Source機能を使用して価格を操作する
* 標準的なカスタマージャーニーの説明
* 標準受注ライフサイクルの説明
...
* Adobe Commerceでのサービスアドオンの特定
* Adobe Commerceのホスティングオプションの特定

第 3 節：デジタルマーケティングと e コマースの基本事項（22%）
...
セクション 4：コンプライアンス/セキュリティの基本事項（10%）

* プライバシー法および支払いセキュリティに関するコンプライアンスの基本を理解する
* Adobe Commerce プロジェクトの一般的なセキュリティ面の特定
...
* [ 買い物かご価格ルール ](https://experienceleague.adobe.com/docs/commerce-admin/marketing/promotions/cart-rules/price-rules-cart.html){target="_blank"}
* [ 新規顧客アカウントオプション ](https://experienceleague.adobe.com/docs/commerce-admin/customers/customer-accounts/configure/account-options-new.html){target="_blank"}
...
* [ 買い物客への支援の提供 ](https://experienceleague.adobe.com/docs/commerce-admin/customers/customer-accounts/manage/login-as-customer.html){target="_blank"}
...
* [SEO の概要 ](https://experienceleague.adobe.com/docs/commerce-admin/marketing/seo/seo-overview.html){target="_blank"}
...
* [PCI コンプライアンス ](https://business.adobe.com/products/magento/pci-compliance.html){target="_blank"}
* [ オムニチャネルマーケティングとマルチチャネルマーケティングの違いを説明します ](https://business.adobe.com/blog/basics/omnichannel-vs-multichannel-marketing){target="_blank"}

**セクション 4**

* [GDPR](https://experienceleague.adobe.com/docs/commerce-operations/security-and-compliance/privacy/gdpr.html){target="_blank"}
* [Adobeセキュリティ  [!DNL Commerce]  ベストプラクティス ](https://www.adobe.com/content/dam/cc/en/trust-center/ungated/whitepapers/experience-cloud/adobe-commerce-best-practices-guide.pdf){target="_blank"}
* [E コマースの Web サイトを ADA に準拠させる方法 ](https://business.adobe.com/blog/perspectives/understanding-ada-compliance-and-how-it-relates-ecommerce-websites){target="_blank"}

## 資格認定の更新

実務担当者資格認定 [!DNL Commerce]Adobeを更新する手順は、次のとおりです。

上記の手順 1 に従い、最初に [Adobe資格情報管理システムに正常にログインしたことを確認してくだ ](https://www.certmetrics.com/adobe){target="_blank"} い。 次に、資格認定を更新するには、以下のAdobe [!DNL Commerce] 実務担当者の資格更新試験（AD5-E840）のリンクをクリックします。

[!BADGE Adobe[!DNL Commerce] 実践者の資格更新に関する試験（AD5-E840）を受ける]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=AD5-E840 newtab=true"}
...
* 対象言語：英語
* 料金：無料
* 試験 ID: AD5-E839 Adobe [!DNL Commerce] Developer Professional
...
* ストア /管理設定およびメニュー項目を作成するときに使用するファイルを特定します。
...
* 様々なタイプの属性の説明
* シナリオを指定した場合、DB スキーマを使用してデータベーステーブルを変更します
* モデル、リソースモデル、コレクションの説明
* エンティティ属性値（EAV）の基本事項の説明
...
* テーマの構造の説明
* シナリオを考えた場合は、JavaScript ファイルの操作（基本）
* 顧客データのフロントエンド使用率の説明

**セクション 5：チェックアウトと売上（12%）**

* 買い物かごコンポーネントの説明
* 買い物かごプロモルールの説明
* シナリオを前提として、チェックアウトの基本的な変更を説明します
* シナリオの場合は、見積データの基本的な使用方法を説明します
* シナリオを考えた場合は、支払い方法と発送方法を設定します
* シナリオを指定した場合は、税務処理基準、通貨、買い物かご、チェックアウトを設定します
...
* [ 管理グリッドの追加 ](https://developer.adobe.com/commerce/php/development/components/add-admin-grid/){target="_blank"}
...
* [ サイト、ストア、ビューの範囲 ](https://experienceleague.adobe.com/docs/commerce-admin/start/setup/websites-stores-views.html){target="_blank"}
...
* [EAV 属性と拡張属性 ](https://developer.adobe.com/commerce/php/development/components/attributes/){target="_blank"}
* [ 宣言型スキーマの設定 ](https://developer.adobe.com/commerce/php/development/components/declarative-schema/configuration/){target="_blank"}
* [ コンポーネントファイル構造を作成します ](https://developer.adobe.com/commerce/php/development/build/component-file-structure/){target="_blank"}。
...
* [ プライベートコンテンツ ](https://developer.adobe.com/commerce/php/development/cache/page/private-content/){target="_blank"}

**セクション 5**

* [ 買い物かご設定 ](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/point-of-purchase/cart/cart-configuration.html){target="_blank"}
* [ 買い物かご価格ルールの作成 ](https://experienceleague.adobe.com/docs/commerce-admin/marketing/promotions/cart-rules/price-rules-cart-create.html){target="_blank"}
* [ 他のチェックアウトフィールドに影響を与えるカスタムフィールドの追加 ](https://developer.adobe.com/commerce/php/tutorials/frontend/custom-checkout/add-checkbox/){target="_blank"}
...
* [ 発送方法のリストのカスタマイズ ](https://developer.adobe.com/commerce/php/tutorials/frontend/custom-checkout/add-shipping-methods/){target="_blank"}
* [ 税設定の指定 ](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/site-store/taxes/tax-settings-general.html){target="_blank"}
...
Developer Professional 認定のAdobeを更新する手順 [!DNL Commerce] 次のとおりです。

上記の手順 1 に従い、最初に [Adobe資格情報管理システムに正常にログインしたことを確認してくだ ](https://www.certmetrics.com/adobe){target="_blank"} い。 次に、資格認定を更新するには、以下のAdobe[!DNL Commerce] 開発者プロフェッショナル更新試験（AD5-E839）のリンクをクリックします。

[!BADGE Adobe [!DNL Commerce] デベロッパー向けプロフェッショナル リニューアル試験（AD5-E839）]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=AD5-E839 newtab=true"}
...
* 対象言語：英語
* 料金：無料
* 試験 ID: AD5-E844Adobe [!DNL Commerce] フロントエンド開発者プロフェッショナルのリニューアル
...
* シナリオを考えた場合、Magento LESS を上書きまたは拡張する機能を示します。
* LESS の基本概念の説明
...
* [ 辞書を使用した文字列のカスタマイズ ](https://developer.adobe.com/commerce/frontend-core/guide/translations/dictionary/)

**セクション 2**

* [referenceBlock および referenceContainer](https://developer.adobe.com/commerce/frontend-core/guide/layouts/xml-instructions/#referenceblock-and-referencecontainer)
...
* [ 新しいレイアウトの作成 ](https://developer.adobe.com/commerce/frontend-core/guide/layouts/create/)
* [ レイアウトを上書きする方法 ](https://developer.adobe.com/commerce/frontend-core/guide/layouts/override/#how-to-override-a-layout)
* [ テンプレートのカスタマイズのチュートリアル ](https://developer.adobe.com/commerce/frontend-core/guide/templates/walkthrough/)
* [magento2/app/design/frontend/Magento Magento/luma/navigation_LayeredNavigation/templates/layer/](https://github.com/magento/magento2/tree/2.4.6/app/design/frontend/Magento/luma/Magento_LayeredNavigation/templates/layer)
...
* [ テーマのスタイルのカスタマイズ ](https://developer.adobe.com/commerce/frontend-core/guide/css/quickstart/customize-styles/)
* [ 親スタイルの拡張 ](https://developer.adobe.com/commerce/frontend-core/guide/css/quickstart/customize-styles/#extend-parent-styles)
* [ 親スタイルをオーバーライド ](https://developer.adobe.com/commerce/frontend-core/guide/css/quickstart/customize-styles/#override-parent-styles)
* [ コンパイル モード ](https://developer.adobe.com/commerce/frontend-core/guide/css/quickstart/compilation-mode/)
...
* [Mixin スコープ ](https://developer.adobe.com/commerce/frontend-core/javascript/mixins/#mixin-scope)
* [ テーマの文字列 ](https://developer.adobe.com/commerce/frontend-core/guide/translations/theory/)
* [ バインディングマップ ](https://developer.adobe.com/commerce/frontend-core/ui-components/concepts/binding-syntax/#binding-map)
* [ アコーディオンウィジェットの初期化 ](https://developer.adobe.com/commerce/frontend-core/javascript/jquery-widgets/accordion/#initialize-the-accordion-widget)

## 資格認定の更新

フロントエンド開発者プロフェッショナル認定 [!DNL Commerce]Adobeを更新するには：

上記の手順 1 に従い、最初に [Adobe資格情報管理システムに正常にログインしたことを確認してくだ ](https://www.certmetrics.com/adobe){target="_blank"} い。 次に、認定資格を更新するには、以下のAdobe[!DNL Commerce] フロントエンド開発者プロフェッショナル更新試験（AD5-E844）リンクをクリックします。

[!BADGE Adobe[!DNL Commerce] フロントエンド開発者のプロフェッショナル向け再開発試験を受ける（AD5-E844）]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=AD5-E844 newtab=true"}
...
* [!DNL Adobe Commerce] 実務担当者エキスパート
* [!DNL Adobe Commerce] 開発者エキスパート
* [!DNL Adobe Commerce] Architectマスター
* [!DNL Adobe Commerce] フロントエンド開発者エキスパート

## [!DNL Adobe Commerce] 資格認定の更新手順

**3 つのアクティビティ** を選択して完了し、それぞれに関連付けられたコース評価に合格します。
...
最初に、「**2 つのコース**」を選択して、各コースの評価を完了し、80% 以上のスコアで合格します。 コースの評価は、無料、オンデマンド、プロクターなし、およびオープンブックです。 評価に合格（80 %）するまで、コースを繰り返すことができます。
  ...
  [ 顧客参照フォーム  [!DNL Adobe Commerce]](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA700){target="_blank"}

  顧客事例が確認されると、Adobeデジタルエクスペリエンス認定制度プログラムから通知が届きます。 参照が承認されない場合、資格認定の有効期限が切れる前であれば、正常に完了するまで再度送信できます。

>[!NOTE]
>
>複数の [!DNL Adobe Commerce] Expert 認定およびマスター認定を保持している場合は、1 つの認定の更新要件を満たし、残りの認定は自動的に更新されます。

### エキスパートおよびマスター向けコースおよびコース評価：

| エキスパートおよびマスター向けコース | コースの評価 |
| ------- | ------- |
| [Adobe [!DNL Commerce] E-Commerceのトレンド ](https://experienceleague.adobe.com/docs/commerce-events/events/commerce-and-coffee/2022/ecommerce-trends.html){target="_blank"} | [ADR-EA703](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA703){target="_blank"} |
...
| [Adobe [!DNL Commerce] AI 自動処理 ](https://experienceleague.adobe.com/docs/commerce-events/events/commerce-and-coffee/2022/ai-and-automation.html){target="_blank"} | [ADR-EA705](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA705){target="_blank"} |
| [[!DNL Commerce]:Experience Platformとその先 ](https://video.tv.adobe.com/v/3413334/){target="_blank"} のデータ統合 | [ADR-EA709](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA709){target="_blank"} |
| [[!DNL Commerce]:Adobe上で構成可能なCommerce [!DNL Commerce]](https://video.tv.adobe.com/v/3413335/){target="_blank"} | [ADR-EA710](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA710){target="_blank"} |
