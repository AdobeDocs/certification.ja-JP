...
product: Magento
role: Developer
badge: label="試験 AD0-E719" type="positive"
mini-toc-levels: 1
...
>[!NOTE]
>
>この試験は [!DNL Adobe Commerce] フロントエンド Developer Professional(AD0-E719) が更新されました。 既に学習を始めている場合や、このバージョンを取得する予定がある場合は、必ず 2023 年 8 月 18 日までに完了してください。 使い始めたばかりの場合は、 [この試験の最新バージョン](ac-p-fedeveloper0623.md).

## 最小エクスペリエンス

0 ～ 12 か月のAdobe体験が必要です [!DNL Commerce] フロントエンド開発と、個々のコンポーネントを提供する技術的なソリューションと連携する機能。
...
* [ウォークスルー第 1 部：単純なページ](https://docs.magento.com/user-guide/cms/page-builder-learn.html){target="_blank"}
